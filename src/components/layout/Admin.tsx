...
const Admin = () => {
    ...
    return <div className="">
        ...
        <div className="bg-[#F1F3F4] flex h-auto">
            <aside className="w-[300px] min-h-screen bg-[#FFFFFF] p-6  h-100vh float-left">
                <ul>
                    ...
                    <li className="mt-3"><button className="bg-red-500 text-white py-2 px-4 rounded-lg" onClick={() => logout()}>logout</button></li>
                </ul>
            </aside>
            <Outlet />
        </div>
