                ...
                <tbody className="divide-y divide-gray-300">
                    {category.map((category, index) =>
                        <tr key={index}>
                            ...
                            <td className="whitespace-nowrap px-4 py-2 text-gray-700 w-[65px]"><button className="py-2 px-3 bg-yellow-300"><Link to={`/admin/category/${category._id}`}>Sửa</Link></button></td>
                        </tr>
                    )}
                </tbody>
            </table>
